...
const DownloadControls = () => {
  ...
  // Function to get bounds including edges
  const getExpandedBounds = (nodes, edges) => {
    const nodesBounds = getRectOfNodes(nodes);
    
       // Include node header in bounds calculation
    ...
    // Expand bounds to include edge paths
      ...
      <div className="relative">
        ...
        {isOpen && (
          <div className="absolute top-full mt-2 right-0 bg-white rounded-md shadow-lg 
            ...
            <button onClick={downloadCsv} className={buttonClass}>
              Download CSV
            </button>
          </div>
        )}
