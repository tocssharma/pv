...
const WorkflowDiagram = ({ data, onNodeSelect, selectedNode,onNodeDoubleClick }) => {
  ...
  console.log("WorkflowDiagram:data",data);
  ...
  const processNodes = useCallback((rawNodes, rawEdges) => {
    console.log("processNodes:rawNodes",rawNodes);
    ...
    nodeMap.forEach((node, nodeId) => {
      console.log("ProcessNodes:nodemap.foreach",node);
...
const getCustomLayout = (nodes, edges) => {
  ...
  console.log("ProcessNodess:WorkflowDiagram:data",data);
    const processedNodes = processNodes(data.nodes, data.edges);
    console.log("ProcessNodess:WorkflowDiagram:processednodes",processedNodes);
    ...
    console.log("Nodes after mapping:", initialNodes);
