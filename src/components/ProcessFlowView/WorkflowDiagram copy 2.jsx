...
class ErrorBoundary extends React.Component {
  ...
  const Flow = ({ nodes, edges, onNodesChange, onEdgesChange, nodeTypes, edgeTypes, onNodeClick }) => {
    const handleNodeClick = (event, node) => {
        console.log("handleNodeClick:onNodeClick",onNodeClick);
...
const WorkflowDiagram = ({ data, onNodeSelect }) => {
  const [nodes, setNodes, onNodesChange] = useNodesState([]);
  const [edges, setEdges, onEdgesChange] = useEdgesState([]);
console.log("WorkflowDiagram:onNodeSelect",onNodeSelect);
